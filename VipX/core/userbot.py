...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("Panther_community")
                await self.one.join_chat("Panther_community")
                await self.one.join_chat("Panther_community")
            except:
                pass
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("Panther_community")
                await self.two.join_chat("Panther_community")
                await self.two.join_chat("Panther_community")
            except:
                pass
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("Panther_community")
                await self.three.join_chat("Panther_community")
                await self.three.join_chat("Panther_community")
            except:
                pass
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("Panther_community")
                await self.four.join_chat("Panther_community")
                await self.four.join_chat("Panther_community")
            except:
                pass
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("Panther_community")
                await self.five.join_chat("Panther_community")
                await self.five.join_chat("Panther_community")
            except:
                pass
